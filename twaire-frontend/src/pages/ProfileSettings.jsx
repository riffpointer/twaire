...
function ProfileSettings() {
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        ...
        setTrailerVideo(data.trailerVideo || null);
  ...
  const handleSubmit = async (e) => {
    ...
    if (trailerVideo) {
      formData.append("trailerVideo", typeof trailerVideo === 'string' ? trailerVideo : trailerVideo._id);
    } else {
      formData.append("trailerVideo", "");
    }
  ...
  return (
    <>
            ...
            >
              {trailerVideo ? (
                <>
                  ...
                  >
                    <img
                      src={`${ApiConfig.serverUrl}/data/thumbnails/${trailerVideo.thumbnail}`}
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 1.5 }}>
                      This video will autoplay for new visitors to your channel.
                    </Typography>
                ...
                <Box sx={{ width: "100%", textAlign: "center", py: 3 }}>
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    No channel trailer selected. Featuring a trailer helps showcase your brand to new visitors.
                  </Typography>
                  <Button
                    variant="contained"
      ...
      <VideoPickerDialog
        ...
        currentTrailerId={trailerVideo?._id || trailerVideo}
      />
    </>
  );
}
